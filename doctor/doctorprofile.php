...
<html lang="en">
    <head>
        ...
        <title>Welcome Admin <?php echo $userRow['doctorFirstName'];?> <?php echo $userRow['doctorLastName'];?></title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="doctordashboard.php">Welcome Admin <?php echo $userRow['doctorFirstName'];?> <?php echo $userRow['doctorLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
        ...
        <!-- jQuery -->
        <script src="../Dr.Profile/assetss/js/jquery.js"></script>
        
        <!-- Bootstrap Core JavaScript -->
        <script src="../Dr.Profile/assetss/js/bootstrap.min.js"></script>
