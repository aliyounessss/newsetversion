...
<html lang="en">
  ...
  <body id="page-top" style="margin-top: 55px !important">
    <div class="nav"></div>
    ...
    <div id="wrapper">
      ...
      >
        ...
        <a
          ...
          href="index.php"
        >
          <div class="sidebar-brand-text mx-3">Doctor Page</div>
        </a>
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="../Dr.Profile/profdoc1.php"
                >Profile Information</a
              >
              <a
                class="collapse-item"
                href="../Dr DashBoard/ProfileSettings.php"
                >My Profile</a
              >
            </div>
          </div>
        ...
        <!-- Heading -->
        <div class="sidebar-heading">Other Pages</div>
        ...
        <div class="sidebar-card d-none d-lg-flex">
          <img
            ...
            alt="..."
          />
          <p class="text-center mb-2">Beirut -Lebanon</p>
          <a
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                >
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small"
                    >Dr. Farah Abi Nader</span
                  >
                  <img class="img-profile rounded-circle" src="doc2.jpg" />
                </a>
