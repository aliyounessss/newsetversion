...
{
header("Location:Dr.Profile.php");
}
...
<html lang="en">
	<head>
		...
		<link href="assetss/css/default/style.css" rel="stylesheet">
		<!-- <link href="assets/css/default/style1.css" rel="stylesheet"> -->
		<link href="assetss/css/default/blocks.css" rel="stylesheet">
	...
	<body>
		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assetss/img/logo.png" height="40px"></a>
				</div>
		...
		<!-- 1st section start -->
		<section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite" style=" background-image: url('cover.jpg')!important;" >
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							?>
							<!-- notification end -->
							<h2>Hi <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?> ! Make appointment Please </h2>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">© Team of Esa </p>
				<p class="pull-right small">Made with <i class="fa fa-heart pomegranate"></i> By Esa Coding Lab</p>
			</div>
		</div>
		<!-- footer end -->
